  ...
  return (
    <div className="p-4 space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        />
        <TransactionCard title="Jumlah TransaksiHari Ini" value={stats.count} />
      </div>
      ...
      <div className="flex flex-wrap justify-end items-center gap-2 text-sm">
        ...
        {Array.from({ length: totalPages }, (_, i) => (
          <button
            key={i + 1}
            className={`px-3 py-1 border rounded ${page === i + 1 ? "bg-indigo-600 text-white" : "hover:bg-gray-300"}`}
          > 
            {i + 1}
          </button>
        ))}
